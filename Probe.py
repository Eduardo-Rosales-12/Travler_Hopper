...
if __name__ == "__main__":
    ...
    #Set Start position
    #relative_pos = (get_pos_estimate(node_id_0)-get_pos_estimate(node_id_0))
    #Set Start position
    velocity = 0.0
    end_position = 0.0
    offset = 0.0
    ...
    set_velocity(node_id_0, velocity, ff_torque)
    set_velocity(node_id_1, velocity, ff_torque)
    
    time.sleep(5)
    
    set_position(node_id_0, end_position+offset, ff_vel, ff_torque)
    set_position(node_id_1, end_position, ff_vel, ff_torque)
