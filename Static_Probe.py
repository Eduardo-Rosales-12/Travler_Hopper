...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            current_position_0, current_velocity_0 = get_encoder_estimate(Motor0)
            current_position_1, current_velocity_1 = get_encoder_estimate(Motor1)
    ...
    # Get the current date and time
        ...
        # Format the filename
        filename = now.strftime("SPROBE-%H:%M_%m-%d.csv")

        # Set up file to save data 
        file_path = "/home/traveler/Traveler_Hopper_sw-bundle/Data/SPROBE"
